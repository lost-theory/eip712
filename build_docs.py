...
def main():
    ...
    # move the current branch (if we're on a branch) to "latest"
...
if __name__ == "__main__":
    ...
    if args.rsync:
        ...
        print(
            "NOTE: If you're making changes to docs locally, go to the 'stable' branch to see "
            "your changes. Also, due to the way sphinx-multiversion integrates with git you need "
            "to commit your changes before building."
        )
        print()
